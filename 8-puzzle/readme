...
# 2×5 퍼즐: 2행×5열, 즉 총 10칸 중 하나가 비어 있고(0), 나머지 9개의 숫자를 슬라이딩하여 목표 상태를 만드는 문제
# 2x5 Puzzle with BFS, DFS, A*

이 레포지토리는 2행×5열 형태의 슬라이딩 퍼즐(총 10칸)을 해결하기 위해  
BFS, DFS, A* 알고리즘을 각각 구현한 예시를 포함합니다.
